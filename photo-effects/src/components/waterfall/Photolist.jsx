    ...
    return (
      ...
      >
        {this.props.pics.map((pic, index) => (
          <Fade bottom cascade>
            <div style={{ fontSize: '1rem', background:'#f0f0f0', padding:'10px', width:'300px', height:'350px', margin:'18px', borderRadius:'8px', boxShadow: '2px 2px 4px 2px rgba(67,221,230,1)', 
