...
class ToolsTopArea extends Component {
  ...
  handleScreenshot = () => {
    domtoimage
      .toJpeg(document.getElementById("canvasTarget"), {
        quality: 1.0,
  ...
  click = () => {
    ...
    //   axios
    //     .post(
    //       `https://photo-effects-backend.herokuapp.com/image-upload`,
    //       storageImg
    //     )
        ...
        <div style={panel_toparea}>
          <div style={panel_options}>
            ...
            <div style={panel_logo_container}>
              ...
              <button onClick={this.click} style={clickStyle}>
                Click Me
              </button>
            </div>
            ...
            <div style={panelbutton_download}>
              <div onClick={this.handleScreenshot} style={dlDiv}>
                <img src={download} />
